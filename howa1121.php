...
<html>
	...
	if (!isset($_POST['username']))
	{
		...
		<form action='howa1121.php' method="post">
	...
	else
	{
		...
		echo 'Connected successfully';
			...
			$query = 'SELECT `description`,`price` FROM `projdata` WHERE `description` LIKE \'%'.htmlentities($_POST['searchstring']).'%\'';
				...
				echo "<tr background=\"fuzzy-blue.jpg\"><th><font color=\"#EA1986\">Description</font></th><th><font color=\"#EA1986\">Price</font></tr>\n";
